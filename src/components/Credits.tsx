          ...
          <ScrollReveal key={idx} delay={idx * 120}>
            ...
            >
              <div>
                ...
                <div className="relative mx-auto h-20 w-20 rounded-2xl bg-gradient-to-tr from-purple-900/60 to-pink-900/60 border border-white/10 flex items-center justify-center group-hover/spotlight:scale-105 group-hover/spotlight:border-purple-500/40 group-hover/spotlight:shadow-[0_0_20px_rgba(168,85,247,0.3)] transition-all duration-300">
                  <span className="text-2xl font-bold text-white/90">
                    {member.name.charAt(0)}
                  </span>
                  <div className="absolute -bottom-1 -right-1 h-5 w-5 rounded-full bg-purple-600 border-2 border-black flex items-center justify-center shadow-sm">
                ...
                {/* Member Info */}
                <div className="mt-4">
                  <div className="text-lg font-bold text-white group-hover/spotlight:text-purple-300 transition-colors">
                    {member.name}
                  </div>
              ...
              <div className="pt-3 border-t border-white/[0.06] mt-4">
                <span className="inline-block px-2.5 py-0.5 rounded-full bg-white/[0.03] border border-white/10 text-[10px] font-mono text-white/50 group-hover/spotlight:border-purple-500/30 transition-colors">
                  {member.tag}
                </span>
              </div>
            </SpotlightCard>
